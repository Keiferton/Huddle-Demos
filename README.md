...
within the configured bounds. The Ender 3 profile uses `xy_feed=3000` and `z_feed=300` mm/min
(50 and 5 mm/s); firmware feed overrides may affect actual speed. Keep the LCD
